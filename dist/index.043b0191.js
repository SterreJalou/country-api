...
})({"eHhMb":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "27338a0f043b0191";
...
},{}],"aIfIE":[function(require,module,exports) {
...
async function getCountryDetails() {
    ...
    try {
        ...
        countryInfoBox.innerHTML = `<li>
                <span class="${getCountryDetails(countryInfo.name)}"></span>
                <p>is situated in${countryInfo.region}.</p>
                <p>It has a population of ${countryInfo.population}.</p>
                <p>The capital is ${countryInfo.capital} and you can pay with ${countryInfo.currencies}</p>
                <p>They speak ${countryInfo.languages}</p>
                `;
    } catch (e) {
        console.error(e);
        if (e.response.status === 500) countryErrorBox.textContent = "Er ging iets mis in de server";
        else if (e.response.status === 404) countryErrorBox.textContent = "Het verzoek is mislukt";
    }
}
getCountryDetails();

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eHhMb","aIfIE"], "aIfIE", "parcelRequirecb08")

//# sourceMappingURL=index.043b0191.js.map
