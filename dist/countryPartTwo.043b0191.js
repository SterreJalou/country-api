...
function formInput(e) {
    ...
    if (userInput.length === 0) console.log("Er is niets ingevuld");
    else {
...
async function getCountryDetails(userInput) {
    try {
        ...
        const resultCountries = await _axiosDefault.default.get(url);
...
},{}]},["eHhMb","aIfIE"], "aIfIE", "parcelRequirecb08")

//# sourceMappingURL=countryPartTwo.043b0191.js.map
